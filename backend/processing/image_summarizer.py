...
from backend.config import VLM_MAX_TOKENS, VLM_MODEL
...
- equation : Transcribe the equation EXACTLY as it appears in the image. If it's in plain text notation, keep it plain text. If it's in LaTeX, keep it in LaTeX. Do NOT convert between formats. Output only the equation itself.
