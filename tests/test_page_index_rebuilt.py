...
from page_index_rebuilt import retriever, toc_generator, tree_builder
...
class TocGenerationTests(unittest.TestCase):
    ...
    @patch("page_index_rebuilt.toc_generator.generate_response")
    ...
    @patch("page_index_rebuilt.toc_generator.merge_tocs")
    @patch("page_index_rebuilt.toc_generator.generate_toc_from_context")
...
class RetrievalTests(unittest.TestCase):
    ...
    @patch("page_index_rebuilt.retriever.append_query_response")
    @patch("page_index_rebuilt.retriever.generate_response")
    @patch("page_index_rebuilt.retriever.retrieve_context_for_query")
