...
from app.page_index_rebuilt import retriever, toc_generator
from app.page_index_rebuilt import tree_builder
...
class TocGenerationTests(unittest.TestCase):
    ...
    @patch("app.page_index_rebuilt.toc_generator.generate_response")
    ...
    @patch("app.page_index_rebuilt.toc_generator.merge_tocs")
    @patch("app.page_index_rebuilt.toc_generator.generate_toc_from_context")
...
class RetrievalTests(unittest.TestCase):
    ...
    @patch("app.page_index_rebuilt.retriever.append_query_response")
    @patch("app.page_index_rebuilt.retriever.generate_response")
    @patch("app.page_index_rebuilt.retriever.retrieve_context_for_query")
