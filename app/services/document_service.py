...
from app.repositories.document_repository import create_document_record, fetch_document_by_tree_path
from app.page_index_rebuilt.pipeline import answer_from_pages_json, build_index
from app.page_index_rebuilt.utils import load_json_data, save_json_data


PROJECT_ROOT = Path(__file__).resolve().parents[1]
DOCS_DIR = PROJECT_ROOT / "docs"
JSON_ROOT = PROJECT_ROOT / "json_files"
PAGES_DIR = JSON_ROOT / "json_pages"
TOCS_DIR = JSON_ROOT / "json_tocs"
TREES_DIR = JSON_ROOT / "json_trees"
